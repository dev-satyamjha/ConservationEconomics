...
[x] Wants are unlimited, resources are limited
...
Accepted Answers: Wants are unlimited, resources are limited
...
Accepted Answers: explicit costs
...
Accepted Answers: property rights
...
Accepted Answers: opportunity costs
...
Accepted Answers: at the margin
...
[x] marginal benefits to marginal costs

Yes, the answer is correct.

Score: 1

Accepted Answers: marginal benefits to marginal costs

Question 9 (1 point)

"an economy that allocates resources through the decentralised decisions of many firms and households as they interact in markets for goods and services" is known as an
...
Accepted Answers: market economy
...
Accepted Answers: comparative advantage